...
parser.add_argument(
    "--vae-dir", type=str, default=None, help="Path to directory with VAE files"
)
parser.add_argument(
    "--gfpgan-dir",
    type=str,
...
parser.add_argument(
    ...
    default=os.path.join(data_path, "styles.csv"),
)
parser.add_argument(
    "--autolaunch",
    action="store_true",
...
parser.add_argument(
    "--no-gradio-queue",
    action="store_true",
    help="Disables gradio queue; causes the webpage to use http requests instead of websockets; was the defaul in earlier versions",
)
parser.add_argument(
    "--skip-version-check",
    action="store_true",
