...
# it utterly impossible to use it alongside with other libraries that also use basicsr, like GFPGAN. # noqa: E501
                    ...
                    try:
                        with torch.no_grad():
                            output = self.net(
                                ...
                                w=w
                                if w is not None
                                else shared.opts.code_former_weight,
                                adain=True,
                            )[0]
