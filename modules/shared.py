...
options_templates.update(
    options_section(
        ("compatibility", "Compatibility"),
        {
            ...
            "dont_fix_second_order_samplers_schedule": OptionInfo(
                False, "Do not fix prompt schedule for second order samplers."
            ),
    ...
    options_section(
        ("ui", "User interface"),
        {
            ...
            "js_modal_lightbox_gamepad": OptionInfo(
                False, "Navigate image viewer with gamepad"
            ),
